...
const drugRoutes = require('./routes/explore/drug');
const locationRoutes = require('./routes/explore/location');
...
app.use('/explore/drug', drugRoutes);
app.use('/explore/location', locationRoutes);
